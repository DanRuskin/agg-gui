 ...
 * @param {number} button
 */
export function on_mouse_down(x, y, button) {
    _assertNum(button);
    wasm.on_mouse_down(x, y, button);
}

export function on_mouse_leave() {
    wasm.on_mouse_leave();
}
 ...
 * @param {number} button
 */
export function on_mouse_up(x, y, button) {
    _assertNum(button);
    wasm.on_mouse_up(x, y, button);
}
 ...
 */
export function on_mouse_wheel(x, y, delta_y) {
    wasm.on_mouse_wheel(x, y, delta_y);
}
 ...
 * @returns {Uint8Array}
 */
export function render_software_pixels(width, height) {
    _assertNum(width);
    _assertNum(height);
    const ret = wasm.render_software_pixels(width, height);
 ...
 * @returns {Uint8Array}
 */
export function render_text_gl_pixels(width, height) {
    _assertNum(width);
    _assertNum(height);
    const ret = wasm.render_text_gl_pixels(width, height);
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
 ...
 * @returns {Uint8Array}
 */
export function render_text_software(width, height) {
    _assertNum(width);
    _assertNum(height);
    const ret = wasm.render_text_software(width, height);
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
 ...
 * @returns {Uint8Array}
 */
export function render_text_tess_agg_pixels(width, height) {
    _assertNum(width);
    _assertNum(height);
    const ret = wasm.render_text_tess_agg_pixels(width, height);
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('demo_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
