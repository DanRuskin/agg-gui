...
use agg_gui::{
    Checkbox, Color, DragValue, DrawCtx, Event, EventResult, FlexColumn, FlexRow, Font, Label,
    Rect, Size, Widget,
};
...
pub(super) const CONTROLS_W: f64 = 360.0;
pub(super) const LABEL_W: f64 = 104.0;
pub(super) const FIELD_W: f64 = 200.0;
...
pub(super) struct FrameState {
    pub(super) inner_m: FourVal, // [L, R, T, B]
    pub(super) outer_m: FourVal,
    pub(super) corner_r: FourVal, // [NW, NE, SW, SE]
    pub(super) shadow_dx: Rc<Cell<f64>>,
    pub(super) shadow_dy: Rc<Cell<f64>>,
    pub(super) shadow_blur: Rc<Cell<f64>>,
    pub(super) shadow_spread: Rc<Cell<f64>>,
    pub(super) shadow_col: Rc<Cell<Color>>,
    pub(super) fill: Rc<Cell<Color>>,
    pub(super) stroke_w: Rc<Cell<f64>>,
    pub(super) stroke_col: Rc<Cell<Color>>,
}
...
impl IntrinsicRow {
    pub(super) fn new(gap: f64, padding: f64, children: Vec<Box<dyn Widget>>) -> Self {
        Self {
            bounds: Rect::default(),
            children,
...
pub(super) struct FramePreview {
    pub(super) bounds: Rect,
    pub(super) children: Vec<Box<dyn Widget>>,
    pub(super) st: Rc<FrameState>,
    pub(super) content: Label,
}
...
pub(super) struct FourValueField {
    pub(super) bounds: Rect,
    pub(super) children: Vec<Box<dyn Widget>>,
    font: Arc<Font>,
    font_size: f64,
